...
public class TestData
{
    ...
    public static readonly List<string> notSortedBySize = CAG.ToList<string>(ab, abc, a);
    ...
    static TestData()
    {
        ...
        list04 = CAG.ToList<int>(0, 1, 2, 3, 4);
        list59 = CAG.ToList<int>(5, 6, 7, 8, 9);
    ...
    public static readonly List<int> list12 = CA.ToInt(CAG.ToList<int>(1, 2));
    public static readonly List<int> list34 = CA.ToInt(CAG.ToList<int>(3, 4));
    public static readonly List<int> list1 = CA.ToInt(CAG.ToList<int>(1));
    public static readonly List<int> list2 = CA.ToInt(CAG.ToList<int>(2));
